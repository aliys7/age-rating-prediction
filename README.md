...
**Short description:** Predict multi-class age ratings for movies and TV shows (MPAA / TV Parental Guidelines) from content metadata (such as title and description) using text features. Aimed at the cold-start scenario (no interaction data).
